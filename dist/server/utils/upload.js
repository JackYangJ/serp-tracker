...
function uploadPicture(ctx, options) {
    ...
    if (type_1.default.isJSON(options) && type_1.default.isString(options.pictureType)) {
        pictureType = options.pictureType;
    }
    const picturePath = path.join(__dirname, '/../../static/output/upload/', pictureType, datetime_1.default.parseStampToFormat(null, 'YYYY/MM/DD'));
